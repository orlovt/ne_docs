...
Для отладки всех процессов понадобится примерно месяц. 80% проблем и доработок будут сделаны в течение 2 недель; более сложные процессы займут остальное время. Также сделаем тестовый период для того, чтобы понять, какие улучшения можно сделать для пользователей 
